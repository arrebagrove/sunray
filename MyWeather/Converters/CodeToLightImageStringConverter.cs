	...
	public class CodeToLightImageStringConverter : IValueConverter
	{
		...
		public object Convert (object value, Type targetType, object parameter, System.Globalization.CultureInfo culture)
		{
			...
			if (code == 0 || code == 1 || code == 2 ||
				code == 3 || code == 17)
			{
				return "warning_light.png";
			}
			if (code == 4 || code == 37 ||code == 38 || 
				code == 39 || code == 45 || code == 47)
			{
				return "thunderstorms_light.png";
			}
			...
			{
				return "fog_light.png";
			}
			if (code == 23 || code == 24)
			{
				return "wind_light.png";
			}
			if (code == 26 || code == 44)
			{
				return "cloudy_light.png";
			}
			if (code == 27 || code == 29)
			{
				return "cloudy_moon_light.png";
			}
			if (code == 28 || code == 30)
			{
				return "cloudy_sun_light.png";
			}
			if (code == 31 || code == 33)
			{
				return "moon_light.png";
			}
			if (code == 32 || code == 34 || code == 36)
			{
				return "sun_light.png";
			}
